...
class SpaceH34 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const SizedBox(height: 34.0);
  }
}
...
class SpaceH33 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const SizedBox(height: 33.0);
  }
}
...
class SpaceH21 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const SizedBox(height: 21.0);
  }
}
...
class SpaceH113 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const SizedBox(height: 113.0);
  }
}
...
class SpaceW148 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const SizedBox(width: 148.0);
  }
}
